                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">                            
                            <a href="registrasi_siswa.php" class="btn btn-primary">Registrasi Siswa
                            </a>                         
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $siswa['nama_kelas']; ?></th>
                                            <th>
                                                ...
                                                <button class="btn btn-data" onclick="confirmDeletion('<?php echo $siswa['nis']; ?>')">Hapus
                                                </button>
                                            </li>
                                        </tr>
                                        <?php } ?>
